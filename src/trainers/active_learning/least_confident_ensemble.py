...
class LeastConfidentScanEnsemble(ActiveTrainerScan):
    """
    Implementation of ensemble AL trainer with Least Confident acquisition function
    """

    def __init__(self, config: ConfigClass, save_dir: str):
        super(LeastConfidentScanEnsemble, self).__init__(config, save_dir, 'LC_Scan_Ensemble_Trainer')
